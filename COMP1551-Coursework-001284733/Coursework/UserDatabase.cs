...
namespace Coursework
{
    ...
    public static class UserDatabase
    {
        ...
        public static string connectionString = $@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename={Path.GetFullPath(Path.Combine(Directory.GetCurrentDirectory(), "..", "..", "Database1.mdf"))};Integrated Security=True";
